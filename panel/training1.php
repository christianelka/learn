<?php
  ...
  if (mysqli_num_rows($result_1) > 0){
    ...
    $id = $_SESSION["id"];
    // echo $id;
    $query_2 = "SELECT isi_soal FROM raw_data WHERE id_soal = $id";
      ...
      <div class="col-lg-20" style="margin-top:4%; width: 100%;">
          ...
          <div class="card mb-3 shadow rounded">
              ...
              <div class="form-group">
                ...
                <p><input type="submit" value="Cek Ringkasan" name="GO"></p>
                <button type="submit" name="GOs" class="btn btn-dark" data-toggle="modal" data-target="#myModal">
                  Check Result </button>
                </form>
              </div>
          </div>
...
<?php  
  ...
  if(isset($_POST['GO']))
  {
    ...
    var_dump($seconds . ' Detik');
    var_dump($time_start . 'Awal');
    var_dump($time_end . 'Akhir');

    $NIM = $_SESSION['username'];
    var_dump($NIM);
    $texts = htmlentities(mysqli_real_escape_string($mysqli,$_POST['comment']));
    $query = "INSERT INTO hasil(username, user_summary, id_soal, lama_pengerjaan) VALUES ('$NIM', '$texts', '$id', '$seconds')";
